          ...
          <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                  ...
                  <form action="{{ url('condicionantes-update/' . $cond->id) }}" method="POST" class="row g-3">
                    @csrf
  
                    <input type="text" class="form-control" id="id_condicionante" name="id_condicionante" value="{{ $cond->id }}">
                    @endforeach
                    <div class="col-12">
                      ...
                      <div class="form-floating ">
                        <textarea class="form-control border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md w-full"
                             id="condicionante" name="condicionante" value="{{ $cond->condicionante }}">{{ $cond->condicionante }}</textarea>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                      ...
                      <div id="date-picker-example" class="md-form md-outline input-with-post-icon datepicker"
                        ...
                        <input placeholder="Select date" type="date" id="prazo_condicionante" name="prazo_condicionante"
                            ...
                            value="{{ $cond->prazo_condicionante }}">
